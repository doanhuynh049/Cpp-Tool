 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/cxxtutrl/lesson3/receive2.cxx#1 $
 */

// receive2.cxx - read a NUMERIC_DATA message and print contents 
// $RTHOME/examples/smrtsock/cxxtutrl/lesson3/receive2.cxx 
