 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/cxxtutrl/lesson3/send3.cxx#1 $
 */

// send3.cxx - send a NUMERIC_DATA message with 3 variables set 
// $RTHOME/examples/smrtsock/cxxtutrl/lesson3/send3.cxx 
...
int main(int argc, char **argv)
{
  ...
  msg.Append((T_STR)"X", 10.0);
  msg.Append((T_STR)"Y", 20.0);
  msg.Append((T_STR)"Z", 30.0);
