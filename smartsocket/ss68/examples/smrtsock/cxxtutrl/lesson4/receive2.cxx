 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/cxxtutrl/lesson4/receive2.cxx#1 $
 */

// receive2.cxx - print out contents of NUMERIC_DATA messages via callback 
// $RTHOME/examples/smrtsock/cxxtutrl/lesson4/receive2.cxx 
...
int main(int argc, char **argv)
{
  ...
  while ((msg = rtServer.Next(T_TIMEOUT_FOREVER)) != NULL) {
