 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/cxxtutrl/lesson4/send.cxx#1 $
 */

// send.cxx - send a NUMERIC_DATA message with 3 variables set 
// $RTHOME/examples/smrtsock/cxxtutrl/lesson4/send.cxx 
