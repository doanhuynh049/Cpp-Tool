 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/cxxtutrl/lesson6/send.cxx#1 $
 */

// send.cxx - send a series of MSG_COUNT messages 
// $RTHOME/examples/smrtsock/cxxtutrl/lesson6/send.cxx 
...
int main(int argc, char **argv)
{
  ...
  // Read a command file 
  TutCommandParseFile((T_STR)"send.cm");
