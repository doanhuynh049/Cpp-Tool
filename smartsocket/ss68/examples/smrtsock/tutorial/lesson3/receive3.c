 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/tutorial/lesson3/receive3.c#1 $
 */

/* receive3.c - read a NUMERIC_DATA message and print out its contents */
/* $RTHOME/examples/smrtsock/tutorial/lesson3/receive3.c */
...
int main(int argc, char **argv)
{
   ...
   * message pointer (i.e., the current field) to the first field in 
   * the data part of the message 
   */
  TipcMsgSetCurrent(msg, 0);

  /* 
   * Move through the data part of the message; print out each variable
   * name, variable value pair in the message
   */
