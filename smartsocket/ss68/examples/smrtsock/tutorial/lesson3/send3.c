 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/tutorial/lesson3/send3.c#1 $
 */

/* send3.c - send a NUMERIC_DATA message with 3 variables set */
/* $RTHOME/examples/smrtsock/tutorial/lesson3/send3.c */
