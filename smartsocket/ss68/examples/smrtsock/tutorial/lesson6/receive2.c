 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/tutorial/lesson6/receive2.c#1 $
 */

/* receive2.c - print out contents of MSG_COUNT messages*/
/* $RTHOME/examples/smrtsock/tutorial/lesson6/receive2.c */
...
int main(int argc, char **argv)
{
  ...
  TutCommandParseFile("receive2.cm");
  ...
  /* Start subscribing to the "/tutorial/lesson6" subject */
