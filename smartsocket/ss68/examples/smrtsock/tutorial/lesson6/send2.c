 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/c/tutorial/lesson6/send2.c#1 $
 */

/* send2.c - send a series of MSG_COUNT messages */
/* $RTHOME/examples/smrtsock/tutorial/lesson6/send2.c */
