 ...
 *
 * $Id: //dev/packages/examples/ss/dev/68/src/java/tutorial/lesson6/ChatApplet.java#1 $
 */
...
public class ChatApplet extends Applet
  ...
  boolean been_initialized = false;
  String my_name;
